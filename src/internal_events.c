...
// Initialize callback function pointers and context pointers to NULL
...
void (*Gamepad_axisMoveCallback)(struct Gamepad_device *device, unsigned int axisID, float value, float lastValue, double timestamp, void *context) = NULL;
...
// Registration functions for device attach/detach and button/axis events
